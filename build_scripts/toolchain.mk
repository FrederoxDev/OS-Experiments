...
toolchain_binutils: $(TOOLCHAIN_PREFIX)/bin/i386-elf-ld

$(TOOLCHAIN_PREFIX)/bin/i386-elf-ld: $(BINUTILS_SRC).tar.xz
...
toolchain_gcc: $(TOOLCHAIN_PREFIX)/bin/i386-elf-gcc

$(TOOLCHAIN_PREFIX)/bin/i386-elf-gcc: $(TOOLCHAIN_PREFIX)/bin/i386-elf-ld $(GCC_SRC).tar.xz
